...
![Overview of Application] (https://github.com/santoshborate/zf3-album/zf3-album.png)
...
To use Album Application:

```bash
$ git clone https://github.com/santoshborate/zf3-album.git
```

Then create the MySql database named `album` and create the table scemas mentioned in `mysql-database.sql`.
